    ...
    <div class="row">
        <div class="col-md-12">
            <h2 class="page-header">
                Cuenta cte # {{ str_pad ($model->id, 7, '0', STR_PAD_LEFT) }}
            </h2>

            <div class="well well-sm">
                <div class="row">
                    <div class="col-xs-6">
                        <input class="form-control typeahead" type="text" readonly value="{{ $model->persona->nombre }}" />
                    </div>
                    <div class="col-xs-2">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td class="text-right">{{$d->entrega}}</td>
