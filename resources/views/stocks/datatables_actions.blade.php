...
<a href="{{ route('stocks.show', $id) }}" class='btn btn-default btn-xs' data-toggle="tooltip" title="Ver">
    <i class="glyphicon glyphicon-eye-open"></i>
</a>

<a href="{{ route('stocks.edit', $id) }}" class='btn btn-info btn-xs' data-toggle="tooltip" title="Editar">
